...
<html:form action="MantenedorDespacho" method="POST">
				...
				<div class="col-sm-9 mt-5" align="left">
					<div class="card border-light mb-3 w-100 shadow-lg p-3 mb-5 bg-body rounded" align="center">
						...
						<table class="table table-striped">
							...
							<logic:iterate name="listaDespachos" id="indice">
								<tbody class="searchable">
									<tr>
										<td>
											<bean:write name="indice" property="idDespacho"/>
										</td>
										<td>
										...
										<td>
											<bean:write name="indice" property="valorDespacho"/>
										</td>
										<td>
